        ...
        <div className="max-w-7xl mx-auto px-4 h-full flex flex-col justify-center">
          ...
          <form onSubmit={handleSearch} className="max-w-2xl">
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-8 py-3 bg-pink-600 text-white rounded-lg font-semibold"
              >
                Cari
              </button>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Perpus System adalah platform manajemen perpustakaan modern yang
            dirancang untuk memudahkan pengelolaan koleksi buku.
          </p>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow">
              ...
              <p className="text-gray-600">
                Jelajahi ribuan koleksi buku digital
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow">
      ...
      <section className="py-16 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Platform manajemen perpustakaan modern
              </p>
            </div>
            <div>
              ...
              <ul className="text-gray-400 space-y-2">
                ...
                <li>
                  <a href="/dashboard/books" className="hover:text-white">
                    Katalog
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8">
            <p className="text-gray-400">
              © 2025 Perpus System. All Rights Reserved.
            </p>
          </div>
        </div>
      </section>
